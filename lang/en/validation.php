...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Wrapper text returned alongside the `errors` bag when a FormRequest
    | fails. The `errors` payload itself keeps its existing structure.
    |
    */
    ...
    */
    ...
    'attributes' => [
        ...
        'image' => 'image',
        'image_id' => 'image',
        'certificate_file_id' => 'certificate file',
        'license_file_id' => 'license file',
